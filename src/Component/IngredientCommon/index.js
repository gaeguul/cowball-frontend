...
export const API = {
  ...
  postIngredientInAmount: async (ingredientId, amount) =>
    await axios.post(`ingredients/stocks`, {
      ingredientId: ingredientId,
      amount: amount,
    }),

  putIngredientInAmount: async (ingredientId, amount) =>
    await axios.put(`ingredients/stocks`, {
      ingredientId: ingredientId,
      amount: amount,
    }),
};
    ...
    <ModalContainer onClose={onClose}>
      <div className='number-picker-dialog'>
        ...
        <div className='dialog-foot'>
          <a
            className={`dialog-button-ok ${loading ? '--loading' : ''}`}
            onClick={() => {
              setLoading(true);
              (async () => {
